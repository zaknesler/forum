                    ...
                    <div class="ml-4 md:ml-0">
                        ...
                        @if ($user->privacy->show_email)
                            <div class="text-sm text-grey-darker flex items-center mt-4">
                                <svg class="fill-current text-grey w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M18 2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4c0-1.1.9-2 2-2h16zm-4.37 9.1L20 16v-2l-5.12-3.9L20 6V4l-10 8L0 4v2l5.12 4.1L0 14v2l6.37-4.9L10 14l3.63-2.9z"/></svg>
            ...
            <div class="flex-grow p-4">
                ...
                @else
                    <div class="bg-white border border-grey-lighter shadow rounded p-8 text-center">
                        <svg class="w-16 h-16 fill-current text-grey mb-8 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 8.586L2.929 1.515 1.515 2.929 8.586 10l-7.071 7.071 1.414 1.414L10 11.414l7.071 7.071 1.414-1.414L11.414 10l7.071-7.071-1.414-1.414L10 8.586z"/></svg>
